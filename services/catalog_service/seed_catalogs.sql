...
CREATE INDEX IF NOT EXISTS idx_catalogos_categoria_seed ON catalogos(categoria);
CREATE INDEX IF NOT EXISTS idx_catalogos_padre_seed ON catalogos(padre_id);
